          ...
          child: Column(
            ...
            children: [
              _buildCreateAccountLogo(),
                ...
                SizedBox(height: 22),
                _buildTextFormFieldWithCountryCode(context),
                SizedBox(height: 20,),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 20),
...
an interactive whatsapp support''',style: GoogleFonts.montserrat(color: ColorConstants.purpledark,fontSize: 10),),
  ...
  Padding _buildTextFormFieldWithCountryCode(BuildContext context) {
    return Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: TextFormField(
                  cursorColor: ColorConstants.grey.withOpacity(.7),
  ...
  Column _buildCreateAccountLogo() {
    return Column(
              children: [
                Image(
                    height: 50,
